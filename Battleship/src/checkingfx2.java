        ...
        EventHandler<ActionEvent> event = new EventHandler<ActionEvent>() { 
            ...
            { 
                ...
                if(coordarr.size()==2){//2
                	...
                	System.out.println(shipsprocessed.contains(checkingfx2.shipnumname));	
                	
                 if(!shipsprocessed.contains(checkingfx2.shipnumname)){//3
                
                	 
                	  System.out.println("inside shiparray doesnt contain");
                	  
                	  shipsprocessed.add(checkingfx2.shipnumname);
                	  
                	  String namenum[]=checkingfx2.shipnumname.split("");
                	...
                	if(axisxystartintx==axisxyendintx){
                		...
                		System.out.println("SHIPSLOTS--:"+checkingfx2.shipnumname);
            ...
            /*	
            	...
            	System.out.println("else ship size----"+humanPlayer.shipsArr.size());
            	System.out.println("we are in else after 5");
