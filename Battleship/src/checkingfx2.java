            ...
            { 
                ...
                if(coordarr.size()==2){
                	...
                	if(axisxystartintx==axisxyendintx){
                		...
                		System.out.println("SHIPSLOTS--:"+checkingfx2.shipnum);
                		...
                		if(checkingfx2.shipnum == Math.abs(axisxyendinty-axisxystartinty)+1){
                		...
                		if(checkingfx2.shipnum ==Math.abs(axisxyendintx - axisxystartintx)){
